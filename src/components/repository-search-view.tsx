    ...
    <div className="flex flex-col gap-3">
      <form onSubmit={runSearch} className="flex gap-3">
        <input
          ...
          className="flex-1 rounded-lg border-2 border-zinc-300 bg-white px-4 py-2 text-base tracking-wide text-black outline-none transition-colors placeholder:text-zinc-400 focus:border-(--neo-line) dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-50 dark:focus:border-(--neo-line)"
        />
        <button
          type="submit"
          disabled={!canSubmit}
