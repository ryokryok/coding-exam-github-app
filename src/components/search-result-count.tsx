...
export function SearchResultCount({ total }: { total?: number }) {
  ...
  return (
    <output className="block w-fit rounded-lg border-2 border-(--neo-line) bg-yellow-300 px-3 py-1 text-base font-bold tracking-wider text-black shadow-[3px_3px_0_0_var(--neo-shadow)]">
      {loaded ? (
